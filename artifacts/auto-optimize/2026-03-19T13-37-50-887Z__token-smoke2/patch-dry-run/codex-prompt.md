...
- Baseline speed for event-fast-par: 5943.840x
- Minimum improvement to keep patch: 1%
- Verification after patch will be handled by the runner: suites=quick,standard, reruns=2, strictFinalParity=true.
...
- Benchmark target speed is 5943.840x with minimum improvement 1%.
